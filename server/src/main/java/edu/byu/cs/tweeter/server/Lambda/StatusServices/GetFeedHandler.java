...
/**
 * An AWS lambda function that returns the statuses for a user's feed.
 */
public class GetFeedHandler extends StatusServiceHandler implements RequestHandler<PagedStatusRequest, PagedStatusResponse>
{
