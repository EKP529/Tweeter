 ...
 */
public class GetFollowingHandler extends FollowServiceHandler implements RequestHandler<PagedUserRequest, PagedUserResponse>
{
    ...
    {
        return getFollowService().getFollowees(request);
    }
}
